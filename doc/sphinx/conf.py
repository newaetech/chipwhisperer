...
# sphinx-quickstart on Wed Jun 08 11:20:24 2016.
#
...
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/common/api/tracesource'))
...
latex_documents = [
    (master_doc, 'star.tex', u'star Documentation',
     u'phonchi', 'manual'),
]
...
man_pages = [
    (master_doc, 'star', u'star Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'star', u'star Documentation',
     author, 'star', 'One line description of project.',
     'Miscellaneous'),
]
