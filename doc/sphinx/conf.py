# -*- coding: utf-8 -*-
#
# ChipWhisperer documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/analyzer/analysis'))
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/analyzer/analysis/diffmode'))
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/analyzer/analysis/partition'))
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/analyzer/attacks'))
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/analyzer/attacks/cpa_algorithms'))
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/analyzer/attacks/profiling_algorithms'))
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/analyzer/attacks/models'))
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/analyzer/models'))
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/analyzer/preprocessing'))
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/analyzer/results'))
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/analyzer/scripts'))
...
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/capture/scripts'))
...
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/hardware'))
sys.path.insert(0, os.path.abspath('../../software/chipwhisperer/hardware/naeusb'))
...
project = u'ChipWhisperer'
copyright = u'2014, NewAE Technology Inc, Colin O\'Flynn'
...
htmlhelp_basename = 'ChipWhispererdoc'
...
latex_documents = [
  ('index', 'ChipWhisperer.tex', u'ChipWhisperer Documentation',
   u'NewAE Technology Inc.', 'manual', True),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = 'modtheme/static/sidebarlogo.png'
...
man_pages = [
    ('index', 'chipwhisperer', u'ChipWhisperer Documentation',
     [u'NewAE Technology Inc, Colin O\'Flynn'], 1)
]
...
texinfo_documents = [
  ('index', 'ChipWhisperer', u'ChipWhisperer Documentation',
   u'NewAE Technology Inc, Colin O\'Flynn', 'ChipWhisperer', 'One line description of project.',
   'Miscellaneous'),
]
