...
static void ClockInit(void)
{
	...
	Cy_SysClk_ClkHfSetSource(0u, CY_SYSCLK_CLKHF_IN_CLKPATH2);
	Cy_SysClk_ClkHfSetDivider(0u, CY_SYSCLK_CLKHF_NO_DIVIDE);
	Cy_SysClk_ClkHfEnable(0u);
	Cy_SysClk_ClkHfSetSource(4u, CY_SYSCLK_CLKHF_IN_CLKPATH2);
	Cy_SysClk_ClkHfSetDivider(4u, CY_SYSCLK_CLKHF_NO_DIVIDE);
	Cy_SysClk_ClkHfEnable(4u);

	/* Configure Path Clocks */
	Cy_SysClk_ClkPathSetSource(3, CY_SYSCLK_CLKPATH_IN_EXT);
	Cy_SysClk_ClkPathSetSource(4, CY_SYSCLK_CLKPATH_IN_EXT);
	Cy_SysClk_ClkPathSetSource(0, CY_SYSCLK_CLKPATH_IN_EXT);
	{
	...
	Cy_SysClk_ClkPathSetSource(1, CY_SYSCLK_CLKPATH_IN_EXT);
	{
	...
	Cy_SysClk_ClkPathSetSource(2, CY_SYSCLK_CLKPATH_IN_EXT);
