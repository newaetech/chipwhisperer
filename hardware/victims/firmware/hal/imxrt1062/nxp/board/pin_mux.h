...
#define BOARD_SEMC_A12_GPIO                                                GPIO4   /*!< GPIO device name: GPIO4 */
#define BOARD_SEMC_A12_PORT                                                GPIO4   /*!< PORT device name: GPIO4 */
#define BOARD_SEMC_A12_PIN                                                   20U   /*!< GPIO4 pin index: 20 */
