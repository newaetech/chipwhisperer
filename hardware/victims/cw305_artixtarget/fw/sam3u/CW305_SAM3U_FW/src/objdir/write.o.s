...
.LVL1:
	...
	.loc 1 115 33 is_stmt 0 view .LVU4
	subs	r0, r0, #1
.LVL2:
...
.L8:
	...
	adds	r6, r6, #1
.LVL4:
	.loc 1 119 19 view .LVU8
	subs	r5, r5, #1
.LVL5:
.L3:
	.loc 1 119 9 discriminator 1 view .LVU9
	.loc 1 119 2 is_stmt 0 discriminator 1 view .LVU10
	cbz	r5, .L1
	.loc 1 120 3 is_stmt 1 view .LVU11
	.loc 1 120 7 is_stmt 0 view .LVU12
	ldr	r3, .L9
	ldr	r0, [r3]
.LVL6:
	.loc 1 120 7 view .LVU13
	ldr	r3, .L9+4
	ldr	r3, [r3]
	ldrb	r1, [r4], #1	@ zero_extendqisi2
.LVL7:
	.loc 1 120 7 view .LVU14
	blx	r3
.LVL8:
	.loc 1 120 6 view .LVU15
	cmp	r0, #0
	bge	.L8
	.loc 1 121 11 view .LVU16
	mov	r6, #-1
.LVL9:
.L1:
	.loc 1 126 1 view .LVU17
	mov	r0, r6
	pop	{r4, r5, r6, pc}
.LVL10:
.L5:
	.loc 1 116 10 view .LVU18
	mov	r6, #-1
	b	.L1
.L10:
	.align	2
...
ptr_put:
	.space	4
	.section	.bss.stdio_base,"aw",%nobits
	.align	2
	.set	.LANCHOR0,. + 0
	.type	stdio_base, %object
	.size	stdio_base, 4
stdio_base:
	.space	4
	.text
