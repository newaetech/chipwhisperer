...
/** \file
 *  \brief Board specific information header for the ChipWhisperer Board.
 *  \copydetails Group_BoardInfo_CHIPWHISPERER
 *
 ...
 *  \defgroup Group_BoardInfo_CHIPWHISPERER CHIPWHISPERER
 *  \brief Board specific information header for the ChipWhisperer
 *  @{
 */

#ifndef __BOARD_CHIPWHISPERER_H__
#define __BOARD_CHIPWHISPERER_H__
