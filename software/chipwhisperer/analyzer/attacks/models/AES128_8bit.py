...
class AES128_8bit(ModelsBase, Plugin):
    ...
    hwModels_toStr = [None, 'LEAK_HW_SBOXOUT_FIRSTROUND', 'LEAK_HD_LASTROUND_STATE',
                'LEAK_HD_SBOX_IN_OUT', 'LEAK_HD_SBOX_IN_SUCCESSIVE', 'LEAK_HD_SBOX_OUT_SUCCESSIVE', 'LEAK_HW_INVSBOXOUT_FIRSTROUND']
