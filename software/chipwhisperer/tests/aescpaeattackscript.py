...
class Attack(UserScriptBase):
    ...
    def initAnalysis(self):
        ...
        self.attack = CPA()
        leakage_object = chipwhisperer.analyzer.attacks.models.AES128_8bit.AES128_8bit(chipwhisperer.analyzer.attacks.models.AES128_8bit.AES128_8bit.LEAK_HW_SBOXOUT_FIRSTROUND)
