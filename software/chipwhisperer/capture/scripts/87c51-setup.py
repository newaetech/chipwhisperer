...
class UserScript(UserScriptBase):
    _name = "CW-Lite/Pro Setup for 87C51"
    _description = "Hardware setup script for CW308T-87C51 target"
    ...
    def run(self):
        ...
        lstexample = [['CW Extra Settings', 'Trigger Pins', 'Target IO4 (Trigger Line)', True],
                      ...
                      ['CW Extra Settings', 'Target IOn GPIO Mode', 'Target IO3: GPIO', 'High'],
                      ['OpenADC', 'Clock Setup', 'CLKGEN Settings', 'Desired Frequency', 7370000.0],
                      ['CW Extra Settings', 'Target HS IO-Out', 'CLKGEN'],
                      ['OpenADC', 'Clock Setup', 'ADC Clock', 'Source', 'CLKGEN x4 via DCM'],
                      ['Simple Serial', 'NewAE USB (CWLite/CW1200)', 'baud', 4800],
                      ['Simple Serial', 'Protocol Version', 'Version', '1.1'],
                      ['Simple Serial', 'Preset Mode', 'SimpleSerial Authentication'],
