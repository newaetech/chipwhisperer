...
# -*- coding: utf-8 -*-
#
# Based almost entirely on work from PyQtGraph library (www.pyqtgraph.org)
# This file changes the look of the Flowchart widget to fit more with
# what was needed for the ChipWhisperer project, with a somewhat more
# streamlined interface, and also using regular QDockWidgets() instead of
# dockwidgets from pyqtgraph
#
# Modifications copyright (c) 2013, Colin O'Flynn <coflynn@newae.com>
# All rights reserved.
#
...
if USE_PYSIDE:
    from pyqtgraph.flowchart import FlowchartTemplate_pyside as FlowchartTemplate
    from pyqtgraph.flowchart import FlowchartCtrlTemplate_pyside as FlowchartCtrlTemplate
else:
    from pyqtgraph.flowchart import FlowchartTemplate_pyqt as FlowchartTemplate
    from pyqtgraph.flowchart import FlowchartCtrlTemplate_pyqt as FlowchartCtrlTemplate
    
from pyqtgraph.flowchart.Terminal import Terminal
from numpy import ndarray
from pyqtgraph.flowchart import library
...
class FlowchartWidget(QtGui.QWidget):
    ...
    def __init__(self, chart, ctrl):
        ...
        self.buildMenu()
        self.nodeToolBox = self.buildToolbox()
        
        laytb = QtGui.QVBoxLayout()
        laytb.addWidget(self.nodeToolBox)
        laytb.addStretch()
        
        layout.addLayout(laytb)
        layout.addWidget(self.view)
        #layout.addWidget(self.selInfo)
    ...
    def nodeButtonPushed(self, nodeType, uselessarg=False):
